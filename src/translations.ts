      ...
      items: [
        {
          ...
          description: [
            'Designed and developed CRM web applications using React, Next.js, and NestJS.',
            'Designed and managed PostgreSQL databases using Prisma ORM.',
            'Deployed applications on Linux VPS in production environments.',
            'Managed systems and networks, including SSH, firewalls, configuration, maintenance, security controls, and infrastructure hardening.',
            'Managed Gandi hosting and VPS infrastructure while implementing backup, recovery, and disaster recovery solutions.',
            'Built Jenkins CI/CD pipelines for builds, tests, and deployments, with application delivery through PM2, Nginx, and SSL/TLS.',
            'Developed KPI dashboards, reporting modules, and operational monitoring tools.',
            'Implemented secure authentication, role-based access control, permissions management, and audit logging.',
            'Integrated and managed document storage using MinIO and object storage services.',
            'Analyzed business requirements, designed software architectures, and supported projects through production delivery.',
            'Provided application maintenance, incident resolution, performance optimization, and production environment support.',
          ],
        },
      ...
      items: [
        {
          ...
          description: [
            'Conception et développement des applications web CRM avec React, Next.js et NestJS.',
            'Conception et gestion de la base de données avec PostgreSQL et Prisma ORM.',
            'Déploiement des applications sur VPS Linux en environnement de production.',
            'Administration système et réseau (SSH, firewall, configuration, maintenance) avec mise en place de mesures de sécurisation et de hardening.',
            "Gestion des hébergements (Gandi, VPS) et implémentation de solutions de sauvegarde et de reprise après incident (backup & recovery).",
            'Mise en place de pipelines CI/CD avec Jenkins (build, tests, déploiement) et déploiement applicatif via PM2 avec configuration Nginx et SSL/TLS.',
            'Développement de tableaux de bord KPI, modules de reporting et outils de suivi opérationnel.',
            "Implémentation de systèmes d'authentification sécurisés, gestion des rôles et permissions (RBAC) et journalisation des actions (audit logs).",
            'Intégration et gestion du stockage documentaire avec MinIO et services de stockage objet.',
            "Analyse des besoins métiers, conception d'architectures logicielles et accompagnement des projets jusqu'à leur mise en production.",
            "Maintenance applicative, correction d'incidents, optimisation des performances et support des environnements de production.",
          ],
        },
        {
