      ...
      items: [
        {
          ...
          description: [
            'Designed and developed CRM and business web applications using React, Next.js, NestJS, and PostgreSQL.',
            'Implemented business workflows, KPI dashboards, reporting tools, and secure authentication with RBAC.',
            'Managed PostgreSQL databases, MinIO storage, and application architecture.',
            'Deployed and maintained production environments on Linux VPS using Nginx, PM2, SSL/TLS, backups, CI/CD pipelines, and custom monitoring dashboards for infrastructure and application health.',
            'Provided application maintenance, troubleshooting, performance optimization, and production support.',
          ],
        },
      ...
      items: [
        {
          ...
          description: [
            "Conception et développement d'applications web CRM et métier avec React, Next.js, NestJS et PostgreSQL.",
            "Implémentation de workflows métier, tableaux de bord KPI, outils de reporting et systèmes d'authentification sécurisés avec RBAC.",
            "Gestion des bases de données PostgreSQL, du stockage MinIO et de l'architecture applicative.",
            "Déploiement et maintenance des environnements de production sur VPS Linux avec Nginx, PM2, SSL/TLS, sauvegardes, pipelines CI/CD et tableaux de bord de monitoring personnalisés pour la santé de l'infrastructure et des applications.",
            "Maintenance applicative, résolution d'incidents, optimisation des performances et support des environnements de production.",
          ],
        },
        {
